	...
	<fieldset>
		<div class="form-group">
			<?php echo Form::label('Place', 'place', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('place', Input::post('place', isset($slot) ? $slot->place : ''), array('class' => 'col-md-4 form-control', 'disabled'=>'disabled')); ?>
...
<?php echo Form::close(); ?>
<p>
	<?php echo Html::anchor('slot/view/'.$slot->id, 'View'); ?> |
	<?php echo Html::anchor('slot', 'Back'); ?></p>
