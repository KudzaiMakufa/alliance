<?php class Custom_UserUtility
{
	...
	public static function slot()
	{
		...
		$marital_status[0]="select slot status";
		$marital_status['occupied']='occupied';
		$marital_status['vaccant']='vacant';
